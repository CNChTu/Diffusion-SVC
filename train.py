...
if __name__ == '__main__':
    ...
    scheduler = StepLRWithWarmUp(optimizer, step_size=args.train.decay_step, gamma=args.train.gamma, last_epoch=initial_global_step-2, warm_up_steps=args.train.warm_up_steps, start_lr=args.train.start_lr)
